...
CONFIG: Dict[str, Any] = {
    "model_name": "efficientnet_b0_from_yolo_labels",
    "epochs": 25,               # İstersen 30-40'a çıkarabilirsin
    "batch_size": 32,
    "lr": 1e-4,                 # EfficientNet için düşük lr iyi
    "img_size": 224,
    "num_classes": 3,           # fire / smoke / none
    "seed": 42,
    "run_dir": os.path.join(ROOT_DIR, "runs", "cls_efficientnet_b0_yolo"),
...
def main():
    ...
    for epoch in range(1, CONFIG["epochs"] + 1):
        ...
        if val_acc > best_val_acc:
            ...
            best_path = os.path.join(CONFIG["run_dir"], "best_efficientnet_b0.pth")
            torch.save(model.state_dict(), best_path)
            print("[OK] En iyi EfficientNet-B0 modeli güncellendi:", best_path)
